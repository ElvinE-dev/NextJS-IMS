...
const CardExpenseSummary = () => {
  ...
  return (
    <div className="bg-white shadow-md rounded-2xl flex flex-col justify-between row-span-3">
        {isLoading ? (
            ...
            <ul className="flex flex-col justify-around items-center xl:items-start py-5 gap-3">
                {expenseCategories.map((entry, index) => (
                    <li key={`legend-${index}`} className="flex items-center text-xs">
                        <span className="mr-2 w-3 h-3 rounded-full" style={{ backgroundColor: colors[index] }}></span>
