...
const Settings = () => {
    ...
    const toggleDarkMode = (state:boolean) => {dispatch(setIsDarkMode(state))}
    ...
    const handleToggleChange = (index: number) => {
        ...
        toggleDarkMode(settingsCopy[index].value)
                        ...
                        <tr className='hover:bg-blue-50' key={setting.label}>
                            ...
                            <td className='py-2 px-4'>
                               {setting.type === "toggle" ? (
                                ...
                                <input type="text" className='px-4 py-2 border rounded-lg text-gray-500 bg-white focus:outline-none focus:border-blue-500'
